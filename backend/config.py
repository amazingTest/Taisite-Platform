...
class Config:
    ...
    _AUTOTEST_PLATFORM_ENV = env_dist.get('AUTOTEST_PLATFORM_ENV')
    _AUTOTEST_PLATFORM_MONGO_HOST = env_dist.get('AUTOTEST_PLATFORM_MONGO_HOST')
    _AUTOTEST_PLATFORM_MONGO_PORT = env_dist.get('AUTOTEST_PLATFORM_MONGO_PORT')
    ...
    _AUTOTEST_PLATFORM_MONGO_DEFAULT_DBNAME = env_dist.get('AUTOTEST_PLATFORM_MONGO_DEFAULT_DBNAME')
    _AUTOTEST_PLATFORM_NLP_SERVER_HOST = env_dist.get('AUTOTEST_PLATFORM_NLP_SERVER_HOST')
